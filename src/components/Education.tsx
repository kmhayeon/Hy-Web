    ...
    <>
      <div className={`lg: sm: m-auto max-w-[960px] px-14 px-14`}>
        ...
        <ol className="dark:border-gray-700 dark:text-gray-400 relative m-4 ">
          <li className="dark:after:bg-neutral-600 mb-10 ml-6 h-fit after:absolute after:left-[-0.02rem] after:top-[1rem] after:mt-px after:h-[42%] sm:after:h-[62%] after:w-px after:bg-[#e0e0e0] ">
            {items.map(item => {
              return (
